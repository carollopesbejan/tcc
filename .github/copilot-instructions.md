...
O ambiente de desenvolvimento local roda em sistema operacional Linux.
...
- Ao sugerir comandos de terminal, assuma sempre o ambiente Linux/Ubuntu.
...
- Aplique o sistema de Injeção de Dependências do FastAPI de forma correta.
